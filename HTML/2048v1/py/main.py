...
def su(event):
    ...
    for _ in range(3):
        for i in range(4, 16):
            ...
            if div.textContent==sopra.textContent and sopra.textContent!='':
...
def giu(event):
    ...
    for _ in range(3):
        for i in range(0, 12):
            ...
            if div.textContent==sotto.textContent and sotto.textContent!='':
...
def sx(event):
    ...
    for _ in range(3):
        for i in range(1, 4):
            ...
            if div.textContent==sinistra.textContent and sinistra.textContent!='':
...
def dx(event):
    ...
    for _ in range(3):
        for i in range(0, 3):
            ...
            if div.textContent==destra.textContent and destra.textContent!='':
